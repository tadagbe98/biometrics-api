    ...
    >
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSub}>Votre tableau de bord santé</Text>
        </View>
      ...
      <View style={styles.disclaimer}>
        <Text style={styles.disclaimerText}>
          ⚠️ Usage personnel uniquement — Non médical
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <MetricCard
          ...
          value={m.temperature?.value} unit="°C"
          color="#f97316"
          onPress={() => navigation.navigate('Temperature')}
        />
        <MetricCard
          icon="❤️" label="Fréquence cardiaque"
          value={m.hr?.value} unit="bpm"
          color="#ef4444"
          onPress={() => navigation.navigate('HeartRate')}
        />
        <MetricCard
          icon="🚶" label="Pas"
          value={m.steps?.value} unit="pas"
          color="#22c55e"
        />
        <MetricCard
          icon="💓" label="HRV"
          value={m.hrv?.value} unit="ms"
          color="#a855f7"
          onPress={() => navigation.navigate('HeartRate')}
        />
        <MetricCard
          icon="🫁" label="Respiration"
          value={m.respiration?.value} unit="resp/min"
          color="#3b82f6"
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.actionsGrid}>
          ...
          >
            ...
            <Text style={styles.actionText}>Activité</Text>
          </TouchableOpacity>
          <TouchableOpacity
